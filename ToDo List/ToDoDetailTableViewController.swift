...
class ToDoDetailTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let tap = UITapGestureRecognizer(target: self.view, action: #selector(UIView.end))
        ...
        LocalNotificationManager.isAuthorized { authorized in
            DispatchQueue.main.async {
                if !authorized && self.reminderSwitch.isOn {
                    self.oneButtonAlert(title: "User Has Not Allowed Notifications", message: "To receive alerts for reminders, open the Settings app, select To Do List > Notifications > Allow Notifications", preferredStyle: .alert)
